    ...
    <div className="group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4">
          <span
            className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider shadow-sm backdrop-blur-sm ${difficultyColors[trek.difficulty] || "bg-gray-100 text-gray-600"}`}
          >
            {trek.difficulty}
          </span>
        </div>
