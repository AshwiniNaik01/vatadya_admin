      ...
      <div className="relative z-10 max-h-screen flex items-center justify-center p-4 m-10">
        <div className="w-full max-w-6xl grid md:grid-cols-2 gap-0 bg-white/5 backdrop-blur-2xl rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
          ...
          <div className="relative hidden md:block overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-br from-blue-600/90 to-blue-800/90 mix-blend-multiply z-10"></div>
            <img
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center bg-linear-to-br from-white/95 to-blue-50/95 backdrop-blur-xl">
            {/* Logo for Mobile */}
            <div className="md:hidden mb-8 text-center">
              <div className="inline-flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center text-white relative overflow-hidden">
                  {/* Sparkle effect */}
                  <div className="absolute inset-0 animate-sparkle-sweep">
                    <div className="absolute top-0 left-0 w-full h-full bg-linear-to-r from-transparent via-white/30 to-transparent skew-x-12 -translate-x-full"></div>
                  </div>
                ...
                <span className="text-2xl font-black text-blue-900 animate-sparkle-text">
                  Vatadya
                </span>
              </div>
            </div>
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              {/* Success Message */}
              {successMessage && (
                <div className="mb-6 p-4 bg-blue-50 border-2 border-blue-500 rounded-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-linear-to-r from-blue-600 to-blue-700 text-white font-black rounded-2xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 disabled:opacity-50 disabled:cursor-not-allowed text-lg"
                >
                  {loading ? (
